...
public class VistaZonaRecomendacionesApp extends PolymerTemplate<VistaZonaRecomendacionesApp.VistaRecomendacionesAppModel> {

    /**
     * Creates a new VistaRecomendacionesApp.
     */
    public VistaZonaRecomendacionesApp() {
